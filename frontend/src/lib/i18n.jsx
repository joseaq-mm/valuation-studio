...
const DICT = {
    es: {
        ...
        "home.hero_sub": "Valuation Studio es un sistema de valoración sencillo basado en proyecciones de ingresos, FCF, márgenes y crecimientos compuestos. Aplicado a cualquier empresa cotizada del mundo, con datos siempre actualizados.",
    ...
    en: {
        ...
        "home.hero_sub": "Valuation Studio is a simple valuation system based on revenue, FCF and margin projections plus compounded growth rates. Works for any listed company in the world, with always-updated data.",
