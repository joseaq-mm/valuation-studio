...
const DICT = {
    es: {
        ...
        "home.hero_sub": "Valuation Studio es un sistema de valoración basado en proyecciones de ingresos, deuda neta, FCF, márgenes y crecimientos compuestos. Aplicado a cualquier empresa cotizada del mundo, con datos siempre actualizados.",
    ...
    en: {
        ...
        "home.hero_sub": "Valuation Studio is a valuation system based on revenue, net debt, FCF and margin projections plus compounded growth rates. Works for any listed company in the world, with always-updated data.",
