...
const DICT = {
    es: {
        ...
        "home.method_03_d": "Cruza todo en la vista Visual (cuadrante y combinados) y valida cada tesis con el módulo KPIs: métricas operativas reales → coeficiente. Señal verde / ámbar / rojo, comparativa y watchlist.",
    ...
    en: {
        ...
        "home.method_03_d": "Cross-check everything in the Visual view (quadrant and combined scores) and validate each thesis with the KPIs module: real operating metrics → coefficient. Green / amber / red signal, comparison and watchlist.",
