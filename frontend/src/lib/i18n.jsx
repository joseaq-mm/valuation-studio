...
const DICT = {
    es: {
        // Nav
        "nav.home": "Inicio",
        "nav.watchlist": "Nivel 2",
        "nav.portfolio": "Nivel 1",
        "nav.portfolio_tip": "Nivel 1: tus acciones preferidas.",
        "nav.watchlist_tip": "Nivel 2: acciones que no son tus preferidas pero te interesan.",
        ...
        "home.hero_sub": "Valuation Studio combina la valoración cuantitativa (proyecciones de ingresos y FCF, deuda neta, márgenes y crecimientos compuestos) con un motor cualitativo de Tesis de inversión por tendencias, una vista Visual de convergencia y un módulo de KPIs que valida cada tesis con datos operativos reales. Para cualquier empresa cotizada del mundo, con datos siempre actualizados.",
        "home.try_with": "Prueba con",
        "home.method_01_t": "Valora",
        "home.method_01_d": "Conecta cualquier ticker global (NYSE, NASDAQ, BME, Xetra, LSE, Euronext…) y calcula Ratio Compra y Ratio Venta con proyecciones a 2 años, márgenes, FCF y crecimientos compuestos. La base cuantitativa.",
        "home.method_02_t": "Construye la tesis",
        "home.method_02_d": "Explora tendencias y desarrolla Tesis por empresa con drivers de crecimiento independientes (TAM sin doble conteo), score cualitativo y TAM Score.",
        "home.method_03_t": "Valida y decide",
        "home.method_03_d": "Cruza todo en la vista Visual (cuadrante y combinados) y valida cada tesis con el módulo KPIs: métricas operativas reales → coeficiente. Señal verde / ámbar / rojo, comparativa y Nivel 2.",
        ...
        "compare.load_watchlist": "Cargar Nivel 2",
        ...
        // Watchlist
        "watchlist.tag": "Acciones que te interesan",
        "watchlist.title": "Nivel 2",
        ...
        "watchlist.login_prompt_text": "Tu Nivel 2 se guarda solo en este navegador. Inicia sesión con Google (botón Entrar arriba) para sincronizarla automáticamente entre tus dispositivos y activar alertas opcionales por email cuando una acción cruce tu zona de compra/venta.",
        // Portfolio
        "portfolio.tag": "Tus acciones preferidas",
        "portfolio.title": "Nivel 1",
        "portfolio.empty_title": "Aún no hay posiciones",
        "portfolio.empty_sub": "Añade las acciones que ya tienes en tu Nivel 1 para ver P/L vivo y compararlo con tus precios objetivo.",
        "portfolio.add_position": "Añadir posición",
        "portfolio.col_shares": "Núm.",
        "portfolio.col_now": "Valor",
        "portfolio.col_pct": "% Cartera",
        ...
        "alerts.banner.default_portfolio": "En esta página las alertas se {active} activan por defecto al añadir una posición (te interesa que te avisen de lo que ya tienes en Nivel 1).",
    ...
    en: {
        // Nav
        "nav.home": "Home",
        "nav.watchlist": "Level 2",
        "nav.portfolio": "Level 1",
        "nav.portfolio_tip": "Level 1: your preferred stocks.",
        "nav.watchlist_tip": "Level 2: stocks that aren't your favorites but interest you.",
        "nav.compare": "Compare",
        "nav.thesis": "Theses",
        ...
        "home.hero_sub": "Valuation Studio blends quantitative valuation (revenue and FCF projections, net debt, margins and compounded growth) with a qualitative Investment Thesis engine by trends, a Visual convergence view and a KPIs module that validates each thesis with real operating data. For any listed company in the world, with always-updated data.",
        "home.try_with": "Try with",
        "home.method_01_t": "Value",
        "home.method_01_d": "Plug in any global ticker (NYSE, NASDAQ, BME, Xetra, LSE, Euronext…) and compute the Buy Ratio and Sell Ratio with 2y projections, margins, FCF and compounded growth. The quantitative base.",
        "home.method_02_t": "Build the thesis",
        "home.method_02_d": "Explore trends and develop per-company Theses with independent growth drivers (TAM with no double-counting), a qualitative score and TAM Score.",
        "home.method_03_t": "Validate & decide",
        "home.method_03_d": "Cross-check everything in the Visual view (quadrant and combined scores) and validate each thesis with the KPIs module: real operating metrics → coefficient. Green / amber / red signal, comparison and Level 2.",
        ...
        "compare.load_watchlist": "Load Level 2",
        "compare.run": "Compare",
        ...
        // Watchlist
        "watchlist.tag": "Stocks you're interested in",
        "watchlist.title": "Level 2",
        ...
        "watchlist.login_prompt_text": "Your Level 2 is stored only in this browser. Sign in with Google (button above) to sync it automatically across devices and to enable optional email alerts when a stock crosses your buy/sell zone.",
        // Portfolio
        "portfolio.tag": "Your preferred stocks",
        "portfolio.title": "Level 1",
