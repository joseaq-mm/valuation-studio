        ...
        <div className="w-full h-full flex flex-col" data-testid="metrics-radar">
            ...
            <div className="flex-1 min-h-[200px]">
                <ResponsiveContainer width="100%" height="100%">
                    <RadarChart data={data} outerRadius="68%" margin={{ top: 12, right: 20, bottom: 8, left: 20 }}>
                        <PolarGrid stroke="#00000020" />
                        <PolarAngleAxis dataKey="axis" tick={{ fontSize: 9.5, fontFamily: "IBM Plex Mono", fill: "#4A4A4A" }} />
